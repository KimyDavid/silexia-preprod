...
routes.api(
  ...
  }, 
  {
    ...
    put:(item, callback) => apiController.editItem({table:'Partners', model:Partner, item:item, order:true}, callback),
    delete:(item, callback) => apiController.deleteItem({table:'Partners', item:item, order:true}, callback)
  }
)
