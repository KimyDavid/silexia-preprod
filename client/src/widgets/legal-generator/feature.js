                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-3 col-6">
                            <div className="px-2 px-md-4 py-3 py-md-7 rounded hover-translate">
                                <div>
                                    <img className="w-75 mb-2" src={require(`../../assets/images/about/speed_test.svg`)} alt="Gagner du temps" loading="lazy" />
                                </div>
                        ...
                        <div className="col-lg-3 col-6">
                            <div className="px-2 px-md-4 py-3 py-md-7 rounded hover-translate">
                                <div>
                                    <img className="w-75 mb-2" src={require(`../../assets/images/about/tasks.svg`)} alt="Assistance" loading="lazy" />
                                </div>
                        ...
                        <div className="col-lg-3 col-6 mt-6 mt-sm-0">
                            <div className="px-2 px-md-4 py-3 py-md-7 rounded hover-translate">
                                <div>
                                    <img className="w-75 mb-2" src={require(`../../assets/images/about/cookie.svg`)} alt="Inventaire des cookies" loading="lazy" />
                                </div>
                        ...
                        <div className="col-lg-3 col-6 mt-6 mt-sm-0">
                            <div className="px-2 px-md-4 py-3 py-md-7 rounded hover-translate">
                                <div>
                                    <img className="w-75 mb-2" src={require(`../../assets/images/about/add_files.svg`)} alt="Mettre à jour rapidement" loading="lazy" />
                                </div>
