...
const Category = ({category, index, categoriesLength, nextCategory}) => {
        ...
        <>
            <div className="autodiag-container mb-5">
                ...
                <div className="autodiag-body">
                    <Question question={category.questions[question]} index={question} />
                </div>
                <footer className="autodiag-footer row align-items-center justify-content-between">
                    <div className="col-12 col-md-9">
                        ...
                        <button onClick={nextStep} className="autodiag-next btn btn-primary btn-small shadow w-100">{ (progress === 1) ? 'Voir les résultats' : 'Prochaine étape'}</button>
                    </div>
                </footer>
            </div>
        </>
